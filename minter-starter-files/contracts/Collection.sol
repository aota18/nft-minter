...
contract Collection is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Net2Dev NFT Collection", "N2D") {}
        ...
        function mint(address _to, uint256 _mintAmount, string memory _imageURI, string memory _name, string memory _description, string memory _properties) public payable {
            ...
            for (uint256 i = 1; i <= _mintAmount; i++) {
                ...
                _setTokenURI(supply+i, formatTokenURI(_imageURI, _name, _description, _properties));
            }
        }
